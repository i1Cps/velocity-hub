...
class VelocityT1(mjx_env.MjxEnv):
    """ Environment to train the T1 to follow velocity commands"""
    def __init__(
        self,
        ...
        self._xml_path  = "main/environments/velocity_t1/model.xml"
        self._mj_model  = mujoco.MjModel.from_xml_path(self._xml_path)
        self._mj_model.opt.timestep = self.sim_dt
        self._mjx_model = mjx.put_model(self._mj_model, impl=self._config.impl)

        # Action scale
        self._action_scale = 0.7
        ...
        self._gravity_noise_scale   = 0.2
        self._linvel_noise_scale    = 0.1
        self._gyro_noise_scale      = 0.2

        # Velocity command ranges
        self._command_range_linvel_x   = [-0.5, 2.5]
        ...
        self._action_rate_cost_weight       = -1.00
...
locomotion.register_environment('velocity_t1', VelocityT1, default_config)
