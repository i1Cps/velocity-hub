...
class VelocityH1(mjx_env.MjxEnv):
    """ Environment to train the H1 to follow velocity commands"""
    def __init__(
        self,
        ...
        self._xml_path  = "main/environments/velocity_h1/model.xml"
        self._mj_model  = mujoco.MjModel.from_xml_path(self._xml_path)
        self._mj_model.opt.timestep = self.sim_dt
        self._mjx_model = mjx.put_model(self._mj_model, impl=self._config.impl)

        # Action scale
        self._action_scale = 0.70
...
locomotion.register_environment('velocity_h1', VelocityH1, default_config)
