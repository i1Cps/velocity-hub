...
class VelocityH1_Play:
    def __init__(self):
        options_path = "main/environments/velocity_h1/options.json"
        xml_path     = "main/environments/velocity_h1/model.xml"
        ...
        # Create agent brain
        brain_neurons = network_model.load_params("models/velocity_h1/model")
        ...
        self._command_step_linvel_x    = 0.2
        self._command_step_linvel_y    = 0.20
...
def _make_training_env(mjx_options: dict[str, Any]) -> VelocityH1:
    env_cfg = mp_registry.get_default_config("velocity_h1")
    env_cfg["impl"] = mjx_options["impl"]
    env_cfg["ctrl_dt"] = mjx_options["ctrl_dt"]
    env_cfg["sim_dt"] = mjx_options["sim_dt"]
    return VelocityH1(config=env_cfg)
