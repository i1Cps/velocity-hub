...
class VelocityKbot(mjx_env.MjxEnv):
    """ Environment to train the Kbot to follow velocity commands"""
    def __init__(
        self,
        ...
        self._xml_path  = "main/environments/velocity_kbot/model.xml"
...
locomotion.register_environment('velocity_kbot', VelocityKbot, default_config)
