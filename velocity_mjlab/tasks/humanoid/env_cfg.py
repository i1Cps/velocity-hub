"""Readable, self-contained generic Humanoid velocity environment."""
...
from .robot_cfg import FOOT_GEOMS, HUMANOID_ACTION_SCALE, get_humanoid_robot_cfg


_BASE_BODY = "humanoid"
_SCAN_BODY = "humanoid_pelvis"
_FOOT_BODIES = r"^(humanoid_left_foot|humanoid_right_foot)$"
_FOOT_SITES = ("humanoid_left_foot", "humanoid_right_foot")


def make_env_cfg(*, rough: bool, play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create the flat or rough generic Humanoid velocity environment."""
