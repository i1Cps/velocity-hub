"""Spot velocity environment configurations."""


from assets.robots.spot.spot_constants import (
    SPOT_ACTION_SCALE,
    get_spot_robot_cfg,
)
...
def spot_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create SPOT rough terrain velocity configuration."""
  ...
  cfg.scene.entities = {"robot": get_spot_robot_cfg()}

  # Set raycast sensor frame to spot base.
  for sensor in cfg.scene.sensors or ():
    if sensor.name == "terrain_scan":
      assert isinstance(sensor, RayCastSensorCfg)
      sensor.frame.name = "body"

  site_names = ("fl_foot", "fr_foot", "hl_foot", "hr_foot")
  geom_names = ("FL", "FR", "HL", "HR")
...
def spot_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Spot flat terrain velocity configuration."""
