...
from assets.robots.unitree_h1.h1_constants import (
    H1_ACTION_SCALE,
    get_h1_robot_cfg,
)
...
def unitree_h1_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  # Set raycast sensor frame to H1 pelvis.
  ...
  geom_names = tuple(
    f"{side}_foot_collision{i}" for side in ("left", "right") for i in range(1, 4)
  )
