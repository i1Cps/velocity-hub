"""Readable, self-contained generic quadruped velocity environment."""
...
_BASE_BODY = "quadruped"
_FOOT_SITES = FOOT_GEOMS
_FOOT_PATTERN = r"^quadruped_(front|back)_(left|right)_foot$"


def make_env_cfg(*, rough: bool, play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create the flat or rough generic quadruped velocity environment."""
    ...
    actions = {
        "joint_pos": JointPositionActionCfg(
            entity_name="robot",
            actuator_names=(JOINT_PATTERN,),
            scale=QUADRUPED_ACTION_SCALE,
    ...
    commands: dict[str, CommandTermCfg] = {
        "twist": UniformVelocityCommandCfg(
            ...
            viz=UniformVelocityCommandCfg.VizCfg(z_offset=0.85),
        )
    }
    ...
    return ManagerBasedRlEnvCfg(
        scene=SceneCfg(
            ...
            num_envs=1,
            extent=2.0,
            entities={"robot": get_quadruped_robot_cfg()},
