"""Readable, self-contained Zbot velocity environment."""
...
_BASE_BODY = "Z_BOT2_MASTER_BODY_SKELETON"
_FOOT_BODIES = r"^(FOOT|FOOT_2)$"
_FOOT_SITES = ("left_foot", "right_foot")


def make_env_cfg(*, rough: bool, play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create the flat or rough Zbot velocity environment."""
    ...
    commands: dict[str, CommandTermCfg] = {
        "twist": UniformVelocityCommandCfg(
            ...
            viz=UniformVelocityCommandCfg.VizCfg(z_offset=0.45),
        )
    }
    ...
    return ManagerBasedRlEnvCfg(
        scene=SceneCfg(
            ...
            num_envs=1,
            extent=2.0,
            entities={"robot": get_zbot_robot_cfg()},
