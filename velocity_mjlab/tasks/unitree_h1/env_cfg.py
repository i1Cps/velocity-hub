"""Readable, self-contained Unitree H1 velocity environment."""
...
from .robot_cfg import FOOT_GEOMS, H1_ACTION_SCALE, get_h1_robot_cfg


_SCAN_BODY = "pelvis"
_BASE_BODY = "torso_link"
_FOOT_BODIES = r"^(left_ankle_link|right_ankle_link)$"
_FOOT_SITES = ("left_foot", "right_foot")


def make_env_cfg(*, rough: bool, play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create the flat or rough Unitree H1 velocity environment."""

    # Sensors

    terrain_scan = RayCastSensorCfg(
        name="terrain_scan",
        frame=ObjRef(type="body", name=_SCAN_BODY, entity="robot"),
        ray_alignment="yaw",
    ...
    commands: dict[str, CommandTermCfg] = {
        "twist": UniformVelocityCommandCfg(
            ...
            viz=UniformVelocityCommandCfg.VizCfg(z_offset=1.85),
        )
    }
    ...
    return ManagerBasedRlEnvCfg(
        scene=SceneCfg(
            ...
            num_envs=1,
            extent=2.0,
            entities={"robot": get_h1_robot_cfg()},
