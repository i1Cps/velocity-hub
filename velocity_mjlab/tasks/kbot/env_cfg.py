"""Readable, self-contained K-Bot velocity environment."""
...
from .robot_cfg import FOOT_GEOMS, KBOT_ACTION_SCALE, get_kbot_robot_cfg


_BASE_BODY = "KD_B_102B_TORSO_BTM"
_SELF_COLLISION_BODY = "base"
_FOOT_BODIES = (
    r"^(LFootBushing_GPF_1517_12|RFootBushing_GPF_1517_12)$"
)
_FOOT_SITES = ("left_foot", "right_foot")


def make_env_cfg(*, rough: bool, play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create the flat or rough K-Bot velocity environment."""
    ...
    commands: dict[str, CommandTermCfg] = {
        "twist": UniformVelocityCommandCfg(
            ...
            viz=UniformVelocityCommandCfg.VizCfg(z_offset=1.4),
        )
    }
    ...
    return ManagerBasedRlEnvCfg(
        scene=SceneCfg(
            ...
            num_envs=1,
            extent=2.0,
            entities={"robot": get_kbot_robot_cfg()},
