"""Spot model and actuator configuration."""
...
SPOT_XML = Path(__file__).parent / "xmls" / "spot.xml"


def get_spec() -> mujoco.MjSpec:
    return mujoco.MjSpec.from_file(str(SPOT_XML))
