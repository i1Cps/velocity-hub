"""Readable, self-contained Spot velocity environment."""
...
from .robot_cfg import SPOT_ACTION_SCALE, get_spot_robot_cfg


_BASE_BODY = "body"
_FOOT_SITES = ("fl_foot", "fr_foot", "hl_foot", "hr_foot")
_FOOT_GEOMS = ("FL", "FR", "HL", "HR")


def make_env_cfg(*, rough: bool, play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create the flat or rough Spot velocity environment."""
    ...
    return ManagerBasedRlEnvCfg(
        scene=SceneCfg(
            ...
            num_envs=1,
            extent=2.0,
            entities={"robot": get_spot_robot_cfg()},
